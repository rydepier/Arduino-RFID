...
// Writing new value block B
 ...
 /*       
// Writing new value block C
// Caution this is the Password Key A and Key B
...
// change this: valueBlockA , to read another block

        status = mfrc522.MIFARE_Read(valueBlockA, buffer, &size);
        Serial.print("Byte : 0 Value :");
        Serial.println(buffer[0]);
        Serial.print("Byte : 1 Value :");
        Serial.println(buffer[1]);
        Serial.print("Byte : 2 Value :");
        Serial.println(buffer[2]);
        Serial.print("Byte : 3 Value :");
        Serial.println(buffer[3]);
        Serial.print("Byte : 4 Value :");
        Serial.println(buffer[4]);
        Serial.print("Byte : 5 Value :");
        Serial.println(buffer[5]);
        Serial.print("Byte : 6 Value :");
        Serial.println(buffer[6]);
        Serial.print("Byte : 7 Value :");
        Serial.println(buffer[7]);
        Serial.print("Byte : 8 Value :");
        Serial.println(buffer[8]);
        Serial.print("Byte : 9 Value :");
        Serial.println(buffer[9]);
        Serial.print("Byte :10 Value :");
        Serial.println(buffer[10]);
        Serial.print("Byte :11 Value :");
        Serial.println(buffer[11]);
        Serial.print("Byte :12 Value :");
        Serial.println(buffer[12]);
        Serial.print("Byte :13 Value :");
        Serial.println(buffer[13]);
        Serial.print("Byte :14 Value :");
        Serial.println(buffer[14]);
        Serial.print("Byte :15 Value :");
